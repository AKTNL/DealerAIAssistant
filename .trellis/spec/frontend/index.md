...
This directory contains guidelines for frontend development. Each file documents actual conventions extracted from the codebase, with real file references and code examples.
